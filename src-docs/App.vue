...
import arrayNavSortable from './json/editors/array-nav-sortable.json'
...
import objectRadios from './json/editors/object-radios.json'
...
import issue17 from './json/issues/issue-17.json'
...
import issue44 from './json/issues/issue-44.json'
...
export default {
    ...
    return {
      ...
      examples: {
        ...
        'Editors': {
          ...
          'editors/object-radios': objectRadios,
        ...
        'Fixed issues': {
          ...
          'issue/issue-17': issue17,
          'issue/issue-24': issue24,
          'issue/issue-35': issue35,
  ...
  methods: {
    ...
    async initEditor(schema, data) {
      ...
      options.data = {
        "title": "User Profile",
        "description": "Registration and profile settings",
        "type": "object",
        "x-format": "grid",
        "properties": {
          "firstName": {
          ...
          "avatarUrl": {
            ...
            "format": "uri",
            "x-grid": { "columns": 12 },
            "x-info": "Direct link to your profile picture"
          },
          "bio": {
            "title": "Bio",
            "type": "string",
            ...
            "maxLength": 300,
            "x-grid": { "columns": 12 },
            "default": "Software developer and open source enthusiast."
          },
          "address": {
            "title": "Address",
            "type": "object",
            "x-format": "grid",
            "x-grid": { "columns": 12 },
            "x-titleIconClass": "fas fa-map-marker-alt",
            "properties": {
              "street": {
                "title": "Street",
                "type": "string",
              ...
              "country": {
                ...
                "x-enumTitles": ["United States", "Canada", "United Kingdom", "Germany", "France", "Australia"],
                "x-grid": { "columns": 3 },
                "default": "US"
              }
            }
          ...
          "preferences": {
            ...
            "x-format": "grid",
            "x-grid": { "columns": 12 },
            "x-titleIconClass": "fas fa-cog",
            "properties": {
              "language": {
                "title": "Language",
                "type": "string",
                "enum": ["en", "es", "fr", "de", "pt"],
                "x-enumTitles": ["English", "Spanish", "French", "German", "Portuguese"],
                "x-grid": { "columns": 6 },
                "default": "en"
              },
              "theme": {
              ...
              "visibility": {
                ...
                "x-enumTitles": ["Public", "Friends Only", "Private"],
                "x-format": "radios-inline",
                "x-grid": { "columns": 6 },
                "default": "public"
              }
